...
if("TRUE" STREQUAL "TRUE")
  ...
  set(waypoint_generator_DEVEL_PREFIX /home/chrisliu/桌面/quadcopter_ws/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /home/chrisliu/桌面/quadcopter_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chrisliu/桌面/quadcopter_ws/src/waypoint_generator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chrisliu/桌面/quadcopter_ws/devel/lib;/opt/ros/noetic/lib)
